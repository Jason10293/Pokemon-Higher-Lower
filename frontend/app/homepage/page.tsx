      ...
      <div className="mt-20 px-6 pb-12">
        <div className="mx-auto max-w-4xl grid gap-6 md:grid-cols-3 text-center">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            <p className="text-2xl font-bold text-white">1,000+ cards</p>
            <p className="text-sm text-muted-foreground mt-2">
              Pulled from real market prices.
            </p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            <p className="text-2xl font-bold text-white">Daily streaks</p>
            <p className="text-sm text-muted-foreground mt-2">
              Chase your best run every day.
            </p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            <p className="text-2xl font-bold text-white">Real prices</p>
            <p className="text-sm text-muted-foreground mt-2">
